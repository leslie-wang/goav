...
func (b *BitStreamFilter) Name() string{
	return C.GoString(b.name)
}
...
func (b *BitStreamFilter) AvBitstreamFilterNext() *BitStreamFilter {
	return (*BitStreamFilter)(C.av_bitstream_filter_next((*C.struct_AVBitStreamFilter)(b)))
}

func AvBitstreamFilterIterate(opaque *unsafe.Pointer) *BitStreamFilter {
	return (*BitStreamFilter)(C.av_bsf_iterate(opaque))
}
//Filter bitstream.
