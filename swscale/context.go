...
func SwsGetcontext(sw, sh int, sf avutil.PixelFormat, dw, dh int, df avutil.PixelFormat, f int, sfl, dfl *Filter,
	p *int) *Context {
...
func SwsGetcachedcontext(ctxt *Context, sw, sh int, sf avutil.PixelFormat, dw, dh int, df avutil.PixelFormat, f int,
	sfl, dfl *Filter, p *float64) *Context {
